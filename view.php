    ...
    <section>
        <div class="landing">
            ...
            <div class="chart-toggle">
                <button class="toggle-btn active" data-target="chart">Διάγραμμα</button>
                <button class="toggle-btn" data-target="table">Πίνακας</button>
            </div>
            <div class="chart">
                ...
                <div class="base">
                    ...
                    <div class="search-field">
                        <div class="year-filter">
                            ...
                            <input type="number" name="year-from" class="year-from" min="2013" value="<?php echo $minYear["minYear"] ?>" >
        ...
        <div class="table-tabs">
            <button class="tab-btn active" data-table="single">Αναλυτικός Πίνακας</button>
            <button class="tab-btn" data-table="summary">Συγκεντρωτικός ανά Έτος</button>
        </div>
        ...
        <div class="table-container summary-table-container" style="display:none; margin-top: 30px;">
            <h3>Συγκεντρωτικός Πίνακας ανά Έτος</h3>
            <table class="data-table summary-table">
                <thead>
                    <tr id="summary-header">
                        <th>Τμήμα</th>
                        <!-- Τα έτη θα προστεθούν εδώ δυναμικά από τη JS -->
                    </tr>
                </thead>
        ...
        <div class="download-container" style="display:none;">
                <button class="download-btn">Κατέβασμα Πίνακα</button>
        </div>
                    ...
                    <div class="ten-percent">
                        <?php
                            ...
                            for ($i = $count - 1; $i > $count - 3; $i--) {
                                ...
                                $yearLabel = $special[count($special) - 1];
                                echo "<div class='year-block'>";
                                echo "<span class='year-title'>{$yearLabel}</span>";
                                echo "<span><span class='year'>Βαθμός Πρώτου:</span> {$baseFirst}</span>";
