<?php
require __DIR__ . '/src/public/home.php';
...
<!--                                <input type="submit" value="Αναζήτηση" class="filter-button">-->
                ...
                <div class="analysis-btn-container">
                    <button class="analysis-btn" onclick="window.location.href='analytics.php'">
                        <i class="fas fa-chart-line"></i> Ανάλυση Βάσεων
                    </button>
                </div>
            </div>
        ...
        <div class="section-info" id="info">
            ...
            <div class="column-container">
                ...
                <div class="section-column">
                    <h5>Προηγμένη Ανάλυση Βάσεων</h5>
                    <i class="fas fa-chart-line"></i>
                    <p> Εξερευνήστε τάσεις και ομαδοποιήσεις τμημάτων μέσω τεχνικών Μηχανικής Μάθησης. 
                        Κατανοήστε τη δυναμική των βάσεων και ανακαλύψτε κρυφά πρότυπα στις προτιμήσεις των υποψηφίων με σύγχρονα διαγράμματα.</p>
                    <div class="cta-top">
                        <a href="#analysis"><input type="button" onclick="window.location.href='analytics.php'" value="Δείτε την ανάλυση"></a>
                    </div>                    
                </div>                
                <div class="section-column">
        ...
        <footer>
            <div class="footer">
                ...
                <span class="footer-text">
                    Ανάπτυξη Εφαρμογής : Λαπούσι Γκενάρντο , Καθοδήγηση: <a href="https://www.iee.ihu.gr/~stoug">Στέφανος Ουγιάρογλου</a>
                </span>
